package com.school.haja.endpoint.event.consumer;

import com.school.haja.PojaGenerated;
import com.school.haja.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.school.haja.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.school.haja.service.event."
